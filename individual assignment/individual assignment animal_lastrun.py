...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\Downloads\\individual assignment\\individual assignment animal_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_norm = visual.TextStim(win=win, name='text_norm',
        text='Press the yellow star and do as said. Please press spacebar when you are ready ',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=1.0, method='sequential', 
        ...
        trialList=data.importConditions('indvidual assignment file of trails.xlsx'),
    ...
    for thisTrial in trials:
        ...
        gotValidClick = False  # until a click is received
        # keep track of which components have finished
        trialComponents = [right_rectangle, left_rectangle, left_image, right_image, trail_sound, trial_mouse]
